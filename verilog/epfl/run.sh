...
mv epfl_eqmap_vivado_results.json vivado2024_no_decomp.json
rm -rf *.rpt

source /opt/xilinx/Vivado/2022.1/settings64.sh
make -f run.mk all TOOL=eqmap_vivado INFO=v2022, -j 16  TIMEOUT=600
mv epfl_eqmap_vivado_results.json vivado_no_decomp.json
rm -rf *.rpt
...
mv epfl_eqmap_vivado_results.json vivado2024_decomp.json
rm -rf *.rpt

source /opt/xilinx/Vivado/2022.1/settings64.sh
make -f run.mk all TOOL=eqmap_vivado INFO=v2022,dyn-decomp -j 16  TIMEOUT=3600 EXTRA_FLAGS="--decomp"
mv epfl_eqmap_vivado_results.json vivado_decomp.json
rm -rf *.rpt
